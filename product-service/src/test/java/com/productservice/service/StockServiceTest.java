...
//         stockService.decreaseStocks(List.of(new UpdateStockReqDto(product.getId(), 10)));
//         Product p1 = productRepository.findById(product.getId()).orElseThrow();
//        assertEquals(0, p1.getStock());
//    }
//
//    @Test
//    @DisplayName("재고가 100개 일때, 고객 130명이 주문하는 경우, 30건은 실패")
...
//                try {
//                    stockService.decreaseStocks(List.of(new UpdateStockReqDto(product.getId(), 1)));
